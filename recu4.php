...
<span class="border">
    ...
    <form method="post" action="sauvegarderRecu4.php">
        <center>
			...
			que j’ai reçu de la part de Mr (Mme)<input type="text" name="name">, Un montant de <input type="text" name="montant"> dinars.
			Mode de paiement : <input type="text" name="reste">,pour
			<input type="text" name="appartement"> mis à  <input type="text" name="immeuble">..
