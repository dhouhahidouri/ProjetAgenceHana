...
if (isset($_POST['sauvegarder'])) {
    ...
    $query = "INSERT INTO recu4 (name, montant, reste, appartement, immeuble, date_signature) VALUES ('$name','$montant', '$reste', '$appartement', '$immeuble', '$date_signature')";

    // Exécutez la requête
    if (mysqli_query($conn, $query)) {
        header("Location: recu4.php");
    } else {
