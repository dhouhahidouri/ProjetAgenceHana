...
if (isset($_POST['sauvegarder'])) {
    ...
    $query = "INSERT INTO facture1 (numero, date, nom, matriculeClient, res, bloc, num, prix1, pourcentage1, montantHT1, totalHT, totalTVA, netAPayer, lettre) VALUES ('$numero', '$date', '$nom', '$matriculeClient', '$res', '$bloc', '$num', '$prix1', '$pourcentage1', '$montantHT1', '$totalHT', '$totalTVA', '$netAPayer', '$lettre')";
